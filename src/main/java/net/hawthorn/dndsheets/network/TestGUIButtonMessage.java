...
import net.hawthorn.dndsheets.procedures.TestProcedure;
...
public class TestGUIButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			TestProcedure.execute(guistate);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		DndsheetsMod.addNetworkMessage(TestGUIButtonMessage.class, TestGUIButtonMessage::buffer, TestGUIButtonMessage::new, TestGUIButtonMessage::handler);
	}
}
