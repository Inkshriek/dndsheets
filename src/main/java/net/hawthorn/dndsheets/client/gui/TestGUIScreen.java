...
import net.hawthorn.dndsheets.network.TestGUIButtonMessage;
...
public class TestGUIScreen extends AbstractContainerScreen<TestGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("fragments_in_time:textures/screens/test_gui.png");
